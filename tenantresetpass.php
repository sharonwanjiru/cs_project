                    ...
                    if (isset($_POST["email"]) && (!empty($_POST["email"]))) {
                        ...
                        if (!$email) {
                           // $error .="Invalid email address";
                            ...
                            $sel_query = "SELECT * FROM `tenants` WHERE email='" . $email . "'";
                        ...
                        //   } 
                            ...
                            $output.='<p><a href="http://localhost/cs_project/tprocesspass.php?key=' . $key . '&email=' . $email . '&action=reset" target="_blank">http://localhost/cs_project/tprocesspass.php?key=' . $key . '&email=' . $email . '&action=reset</a></p>';
                            $body = $output;
