...
<head>
    ...
    <title>Tenant Update Form</title>
</head>
<body>
    <div class="container">
        <div class="row">
            <div class="col-lg-6 m-auto">
                <div class="card mt-5">
                    <div class="card-title">
                        <h3 class="bg-success text-white text-center py-3">Tenant Update Form</h3>
                    </div>
                    <div class="card-body">
                        <form action="update.php?ID=<?php echo $tenantid?>" method="post">
